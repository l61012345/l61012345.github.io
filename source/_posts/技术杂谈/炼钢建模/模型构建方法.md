...
## 系统简易验证
运行系统，得到最终的输出为：  
<img src= https://cdn.jsdelivr.net/gh/l61012345/Pic/img/20221116154214.png width=50%>  
...
$$HRC_t=\frac{HRC_q+17}{\frac{T_t}{T_{ref}}-2.8}, T_{ref}=167K \tag{8}$$
其中$T_t$是回火温度。  
根据[9]中提到的S45C的最佳回火温度为550℃-600℃。  
如果取回火温度为550℃，那么$T_t=823.1K$，带入到式$(8)$中得到回火后硬度为35.17HRC。  
符合[9]中对于最佳回火硬度范围的描述。  
