...
>[3] Estimation of hardness during heat treatment of Steels Abhaya Simha N. R et al, 2020.  
...
$$𝐻_𝐵=−323+185𝐶+330𝑆𝑖+153𝑀𝑛+65𝑁𝑖+144𝐶𝑟+191𝑀𝑜+\\(89+53𝐶−55𝑆𝑖−22𝑀𝑛−10𝑁𝑖−20𝐶𝑟−33𝑀𝑜)𝑙𝑜𝑔𝑉𝑟 \tag{6}$$
$$𝐻_{𝐹+𝑃}=42+223𝐶+53𝑆𝑖+30𝑀𝑛+12.6𝑁𝑖+7𝐶𝑟+19𝑀𝑜+\\(10−19𝑆𝑖+4𝑁𝑖+8𝐶𝑟+130𝑉)𝑙𝑜𝑔𝑉𝑟 \tag{7}$$
...
### 各种成分的体积分数
一般情况下，钢铁试棒中各种成分的体积分数是通过在显微镜下观察微结构和相应的计算公式得出的。论文[4]中提到了各种成分的体积分数是关于温度的动态变化函数。本项目只需要获得淬火后冷却到室温的钢铁硬度即可，这一数据在论文[5]中有提到。论文[5]中指出，JIS-S45C钢铁在设置的不同冷却速率下，冷却到室温时各种成分的体积分数如下表所示：    
...
### 各种元素的质量分数
利用论文[5]中提到的数据，模拟淬火过程使用的钢材将会是JIS-S45C碳合金钢，这一钢铁的元素含量在日本行业标准[6]中提到：  
